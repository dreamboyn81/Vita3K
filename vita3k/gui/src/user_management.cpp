...
#ifdef __ANDROID__
                // On Android, resolve the picked file path from content URI / sandbox path to actual storage path
                avatar_path = host::dialog::filesystem::resolve_host_path(avatar_path);
#endif
